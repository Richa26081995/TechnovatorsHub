...
const quizdata=[
      {
        question:"Which class can access all public and protected methods and fields of its super class?",
        options:["Inner class", "outer class", "sub-class", "super-class"],
        answer:"sub-class",
        category:1
      },
      {
        question:"Method,Field can be accessed from the same class to which they belong.?",
        options:["public", "protected", "Default", "Private"],
        answer:"Private",
        category:2
      },
      {
        question:"Which tool is required on each machine to run a Java program?",
        options:["JDK", "SDK", "JRE", "CVS"],
        answer:"JRE",
        category:3
      },
      {
        question:"Which method of the Runnable interface that must be implemented by all threads?",
        options:["Run()", "Start()", "Sleep()", "Wait()"],
        answer:"Run()",
        category:1
      },
      {
        question:"Which Keyword is used If a class has multiple constructors defined,it's possible to call a constructor from another constructor’s body?",
        options:["super()", "constant()", "this()", "None Of These"],
        answer:"this()",
        category:2
      },
      {
        question:"Base class for all exceptions?",
        options:["Java.throwable", "Java.Lang.throwable", "Java.Lang.Exception", "Java.Lang.throwables"],
        answer:"Java.Lang.throwable",
        category:3
      },
      {
        question:"Dynamic binding uses which information for binding?",
        options:["type", "object", "Both", "None"],
        answer:"object",
        category:2
      },
      {
      ...
      },
      {
        ...
        options:["class B + class A {}", "class B inherits class A {}","class B extends A {}", "Both b and c above"],
        answer:"class B extends A {}",
        category:2
      },
      {
        question:"Which of these constructors is used to create an empty String object?",
        options:["String()", "String(void)", "String(0)", "None of the mentioned"],
        answer:"String()",
        category:3
      },
      {
