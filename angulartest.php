...
const quizdata=[
      {
        question:"What is MVC (Mode View Controller)?",
        options:["It is a services for Java built function", "It is marker for DOM elements", "It is a software design pattern for developing web applications", "None of these"],
        answer:"It is a software design pattern for developing web applicationse",
        category:1
      },
      {
        question:"How does an object or function can get hold of its dependencies in angular js?",
        options:["Typically using the new operator, dependency can be created", "By referring to a global variable, dependency can be looked up", "Dependency can be passed into where it is required", "all of the above"],
        answer:"all of the above",
        category:2
      },
      {
        question:"What is link function is used for in angular js?",
        options:["It is used for registering DOM listeners as well as instance DOM manipulation", "It is used to retrieve object instances as defined by provider", "It is used for template DOM Manipulation and collect all of the directives", "The method traverses the DOM and matches the directives"],
        answer:"It is used for registering DOM listeners as well as instance DOM manipulation",
        category:3
      },
      {
        question:"Explain what Angular JS routes does?",
        options:["Automatic synchronization of data between the model and view components", "Enables you to create different URLs for different content in your application", "Link the template with scope by calling the linking function returned from the previous step", "To propagate any model changes through the system into the view from outside of the Angular realm"],
        answer:"Enables you to create different URLs for different content in your application",
        category:1
      },
      {
        question:"What does the $dirty flag indicates in angular js?",
        options:["it indicates the value cannot be changed", "It indicates the form has invalid data", "It indicates that value has been changed", "None of the above"],
        answer:"It indicates that value has been changed",
        category:2
      },
      {
        question:"What is the factory method is used for?",
        options:["It is used for creating the directive", "It is used for template DOM manipulation", "It is used for styling of form", "To check how code gets hold of its dependencies"],
        answer:"It is used for creating the directive",
        category:3
      },
      {
        question:"ng-init directive in angular js is used for?",
        options:["Wraps a raw DOM element or HTML string as a jQuery element", "Allows you to evaluate an expression in the current scope", "Determines if two objects or two values are equivalent", "Serializes input into a JSON-formatted string"],
        answer:"Allows you to evaluate an expression in the current scope",
        category:2
      },
      {
        question:"Explain what is angular.bootstrap is used for?",
        options:["Determines if a reference is a DOM element", "It deserializes a JSON string", "It used for manually starting up angular application","All of the above"],
        answer:"It used for manually starting up angular application",
        category:3
      },
      {
      ...
      {
        question:"Which of the following directive bootstraps AngularJS framework?",
        options:["ng-init", "ng-app","ng-controller", "ng-bootstrap"],
        answer:"ng-app",
        category:2
      },
      {
        question:"The ng-model directive is used for __________.",
