...
const quizdata=[
      ...
      {
        question:"Which of the following is the correct syntax to display “Technovators Hub” in an alert box using JavaScript?",
        options:["alertbox(“Technovators Hub”);", "msg(“Technovators Hub”);", "msgbox(“Technovators Hub”);", "alert(“Technovators Hub”);"],
        answer:"alert(“Technovators Hub”);",
        category:2
      },
      {
      ...
      {
        question:"What is the syntax for creating a function in JavaScript named as Techfunc?",
        options:["function = Techfunc()", "function Techfunc()", "function := Techfunc()", "function : Techfunc()"],
        answer:"function Techfunc()",
        category:1
      },
      {
