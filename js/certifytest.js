...
const quizdata=[
      {
        ...
        options:["const", "constant", "define", "#pragma"],
        answer:"define",
        category:1
      },
      {
        question:"Which of the following is the way to create comments in PHP?",
        options:["// commented code to end of line", "/* commented code here */ ", "# commented code to end of line", "all of the above"],
        answer:"all of the above",
        category:2
      },
      {
        question:"What does PHP stand for?",
        options:["Preprocessed Hypertext Page", "Hypertext Markup Language", "Hypertext Preprocessor", "Hypertext Transfer Protocol"],
      ...
      {
        question:"Which of the following is NOT a magic predefined constant?",
        options:["__LINE__", "__FILE__", "__DATE__", "__CLASS__"],
        answer:"__DATE__",
        category:2
      },
      {
        question:"What is the strpos() function used for?",
        options:["Find the last character of a string", "Both b and c", "Search for character within a string", "Locate position of a string’s first character"],
        answer:"Search for character within a string",
        category:3
      },
      {
        question:"Which of the following differences are valid between PHP 4 and PHP 5?",
        options:["Built-in native support for SQLite", "Both a and c", "improved MySQL support", "Support for inheritance"],
        answer:"Both a and c",
        category:2
      },
      {
        question:"What is the difference between GET and POST method?",
        options:["GET displays the form values entered in the URL of the address bar where as POST does not.", "POST displays the form values entered in the URL of the address bar where as GET does not.", "There is no difference" 
, "Both 1 & 2"],
        answer:"GET displays the form values entered in the URL of the address bar where as POST does not.",
        category:3
      },
      {
        question:"____________ function in PHP Returns a list of response headers sent (or ready to send)",
        options:["header()", "headers_list()", "header_sent()", "header_send()"],
        answer:"headers_list()",
        category:1
      },
      {
        question:"What is array_keys() used for?",
        options:["Compares array keys, and returns the matches", "Checks if the specified key exists in the array","Returns all the keys of an array", "Both b and c above"],
        answer:"Returns all the keys of an array",
        category:2
      },
      {
        question:"What is the difference between echo and print?",
        options:["They both behave the same.", "Print can take multiple parameters where as echo cannot", "Echo can take multiple parameters where as print cannot", "Print is a function where as echo is not."],
        answer:"Echo can take multiple parameters where as print cannot",
        category:3
      },
      {
        question:"What is the purpose of $_SESSION[]?",
        options:["Used to register a global variable", "Used to initialize a session.","Used to store variables of the current session","none of the above"],
